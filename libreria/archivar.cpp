...
void archivar(Paciente *&archivados, int j, Paciente *&array, int i){
    ...
    archivados[j].UltimaConsulta.fecha_solicitado = array[i].UltimaConsulta.fecha_solicitado;
    archivados[j].UltimaConsulta.fecha_turno = array[i].UltimaConsulta.fecha_turno;
